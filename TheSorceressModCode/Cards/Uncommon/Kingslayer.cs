    ...
    TargetType.AllEnemies)
{
        ...
        CardPlay play)
    {
        ...
        await DamageCmd.Attack(this.DynamicVars.Damage.BaseValue).FromCard((CardModel) this, play).Targeting(theKing).WithHitFx("vfx/vfx_attack_slash").Execute(choiceContext);
    }
