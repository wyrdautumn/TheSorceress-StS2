...
public class PerfectDistractionAncient : TheSorceressModAncientsAwakenedCard
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new PowerVar<PrimedPower>(7)];
    public override IEnumerable<CardKeyword> CanonicalKeywords => [CardKeyword.Exhaust];
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        [HoverTipFactory.FromPower<PrimedPower>(),HoverTipFactory.Static(SorceressKeywords.Rekindle),..AddAncientsAwakened()];
